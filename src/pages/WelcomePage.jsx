  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(59,158,255,0.1) 0%, transparent 65%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontSize: 44, margin: '0 auto',
          boxShadow: '0 0 60px rgba(59,158,255,0.3), 0 0 120px rgba(59,158,255,0.1)',
        }}>❄</div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ color: 'var(--text-3)', fontSize: 14, letterSpacing: '0.12em', marginBottom: 10 }}>
          مرحباً بك في
        </p>
        <h1 style={{
        ...
        <div style={{
          ...
          أهلاً، <span style={{ color: 'var(--accent)' }}>{displayName}</span> 👋
        </div>
